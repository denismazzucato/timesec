...
@Timeit("input_stream_analysis")
def input_stream_analysis(function: MyFunction) -> UsageAbstractDomain:
  initial_deps = SyntacticDependencies.initialize({ MyVariable(SYMBOLIC_VARIABLE_NAME) })
  iterator = Iterator()
