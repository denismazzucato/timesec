...

{
  ...
  if (param_1 != 0) {
    ...
    do {
      ...
      bVar8 = CARRY8(*param_2,uVar17 * *param_4);
      uVar15 = 1;
      if (param_1 != 1) {
        do {
          uVar19 = param_2[uVar15];
          uVar20 = uVar17 * param_4[uVar15];
          uVar21 = uVar19 + uVar18 + (ulong)bVar8;
          auVar3._8_8_ = 0;
          auVar3._0_8_ = uVar17;
          auVar6._8_8_ = 0;
          auVar6._0_8_ = param_4[uVar15];
    ...
    do {
      ...
      bVar8 = !bVar7;
      uVar15 = ~(param_4[uVar9] & -uVar12);
      bVar7 = CARRY8(uVar16,uVar15) || CARRY8(uVar16 + uVar15,(ulong)bVar7);
      param_2[uVar9] = uVar16 - ((param_4[uVar9] & -uVar12) + (ulong)bVar8);
      uVar9 = uVar9 + 1;
    } while (uVar9 != param_1);
  }
