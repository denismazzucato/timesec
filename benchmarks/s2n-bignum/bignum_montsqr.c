...

{
  ...
  if (param_1 != 0) {
    ...
    do {
      ...
      bVar9 = CARRY8(*param_2,uVar18 * *param_4);
      uVar16 = 1;
      if (param_1 != 1) {
        do {
          uVar20 = param_2[uVar16];
          uVar21 = uVar18 * param_4[uVar16];
          uVar22 = uVar20 + uVar19 + (ulong)bVar9;
          auVar4._8_8_ = 0;
          auVar4._0_8_ = uVar18;
          auVar7._8_8_ = 0;
          auVar7._0_8_ = param_4[uVar16];
    ...
    uVar10 = 0;
    do {
      bVar8 = CARRY8(param_2[uVar10],~param_4[uVar10]) ||
              CARRY8(param_2[uVar10] + ~param_4[uVar10],(ulong)bVar8);
      uVar10 = uVar10 + 1;
    } while (uVar10 != param_1);
    bVar9 = true;
    uVar10 = 0;
    do {
      ...
      uVar17 = param_4[uVar10] & -(ulong)(uVar13 != 0 || CARRY8(uVar13 - 1,(ulong)bVar8));
      bVar1 = !bVar9;
      uVar16 = ~uVar17;
